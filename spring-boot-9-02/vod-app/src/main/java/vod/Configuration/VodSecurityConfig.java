    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(request-> request
                        .requestMatchers(HttpMethod.POST, "/webapi/mangas").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/webapi/mangastore").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/webapi/mangastores/**").authenticated()
